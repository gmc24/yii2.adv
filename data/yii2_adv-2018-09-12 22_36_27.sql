...
-- Дамп данных таблицы yii2_adv.migration: ~8 rows (приблизительно)
...
INSERT INTO `project` (`id`, `title`, `description`, `active`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(2, 'first pr', 'first project', 1, 1, 1, 0, 1536773123),
...
-- Дамп данных таблицы yii2_adv.project_user: ~6 rows (приблизительно)
