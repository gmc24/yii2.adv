...
-- Дамп данных таблицы yii2_adv.migration: ~12 rows (приблизительно)
...
-- Дамп данных таблицы yii2_adv.project: ~2 rows (приблизительно)
DELETE FROM `project`;
/*!40000 ALTER TABLE `project` DISABLE KEYS */;
INSERT INTO `project` (`id`, `title`, `description`, `active`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(2, 'first pr', 'first project', 1, 1, 2, 0, 1537205523),
	(3, '2nd pr', 'second project', 1, 1, 1, 0, 1536773223),
	(4, '3d pr', 'dfgdfgdfg', 1, 1, 1, 1536773240, 1536773250);
...
-- Дамп данных таблицы yii2_adv.project_user: ~5 rows (приблизительно)
...
-- Дамп данных таблицы yii2_adv.task: ~1 rows (приблизительно)
DELETE FROM `task`;
...
INSERT INTO `task` (`id`, `title`, `description`, `estimation`, `project_id`, `executor_id`, `started_at`, `completed_at`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(7, '1st task', 'my first task', 1, 2, 2, NULL, NULL, 1, 2, 0, 1537224897);
...
-- Дамп данных таблицы yii2_adv.user: ~3 rows (приблизительно)
DELETE FROM `user`;
...
INSERT INTO `user` (`id`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `status`, `avatar`, `created_at`, `updated_at`) VALUES
	...
	(2, 'admin2', 'Lqk9c_4VZoK1Wo2lrhyIDscyxopJA2H5', '$2y$13$UfiM9bZ9AHFgX29hQr7JKeeDAtva7ez/3gSzVuimUa8ciMfGUVJSW', NULL, 'admin2@adm.in', 10, NULL, 1536016038, 1536016038),
	(4, 'admin3', '_lvje6ziez4iUxl4zY1CoRjA1uY5qa09', '$2y$13$G1HXPHHc908y5qxADZo3ZOpbjiIaB4blNL13Ii.5v37GbNlpV2nVy', NULL, 'admin3@adm.in', 10, NULL, 1536016698, 1536054850);
